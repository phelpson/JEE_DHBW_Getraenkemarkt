...
public class KundeFacadeREST extends AbstractFacade<Kunde> {
    ...
    public void create(Kunde entity) {
        super.create(entity);
    }
    ...
    @Path("{id}")
    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public void edit(@PathParam("id") Long id, Kunde entity) {
        super.edit(entity);
    }
    ...
    @Path("{from}/{to}")
    @Produces({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public List<Kunde> findRange(@PathParam("from") Integer from, @PathParam("to") Integer to) {
